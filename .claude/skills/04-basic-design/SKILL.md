---
name: strands-04-basic-design
description: Strands Agents SDKのAIエージェント開発ワークフローの基本設計フェーズ（04_basic-design）を実行するスキル。「ツール基本設計を作って」「データモデル基本設計を書いて」「エージェント基本設計を作りたい」「ハンドラー基本設計を作って」「セッションマネージャ基本設計を書いて」など、基本設計フェーズの成果物作成に関する指示があれば必ずこのスキルを使用する。AIエージェント開発、Strands、基本設計、コンポーネント設計のキーワードが出た場合にも積極的にこのスキルを適用する。
---

# 04_basic-design フェーズ スキル

Strands Agents SDKのAIエージェント開発ワークフローにおける基本設計フェーズの成果物を、
...
> **注意**: ツール基本設計（BD-01）とエージェント基本設計（BD-03）はシステムの業務ドメインに応じて
> 複数作成する（ツールごと、エージェントごとに1ファイル）。ハンドラー基本設計（BD-04）も同様。
> 出力ファイル名の `[ツール名]`・`[エージェント名]`・`[ハンドラー名]` は実際のコンポーネント名に置き換える。

| # | 成果物名 | ID | prompt | template | 出力先（例） |
|---|---|---|---|---|---|
| 1 | ツール基本設計 | BD-01 | `prompts/04_basic-design/ツール基本設計.md` | `templates/04_basic-design/ツール基本設計テンプレート.md` | `../artifacts/04_basic-design/outputs/[ツール名]基本設計.md` |
| 2 | データモデル基本設計 | BD-02 | `prompts/04_basic-design/データモデル基本設計.md` | `templates/04_basic-design/データモデル基本設計テンプレート.md` | `../artifacts/04_basic-design/outputs/データモデル基本設計.md` |
| 3 | エージェント基本設計 | BD-03 | `prompts/04_basic-design/エージェント基本設計.md` | `templates/04_basic-design/エージェント基本設計テンプレート.md` | `../artifacts/04_basic-design/outputs/[エージェント名]基本設計.md` |
| 4 | ハンドラー基本設計 | BD-04 | `prompts/04_basic-design/ハンドラー基本設計.md` | `templates/04_basic-design/ハンドラー基本設計テンプレート.md` | `../artifacts/04_basic-design/outputs/[ハンドラー名]基本設計.md` |
| 5 | セッションマネージャ基本設計 | BD-05 | `prompts/04_basic-design/セッションマネージャ基本設計.md` | `templates/04_basic-design/セッションマネージャ基本設計テンプレート.md` | `../artifacts/04_basic-design/outputs/セッションマネージャ基本設計.md` |
| 99 | フェーズ品質チェック | BD-PHASE-REVIEW | — | — | `../artifacts/04_basic-design/reviews/フェーズ品質チェック_review.md` |

### 依存関係

| 成果物 | 依存する成果物ID |
|---|---|
| BD-01 | SR-03, SR-04, SR-09, SR-10, SR-15, SR-17, SD-01, SD-04, SD-05, SD-07 |
| BD-02 | SR-09, SR-10, SR-16, SR-17, SD-02, SD-07, BD-01 |
| BD-03 | SR-03, SR-04, SR-05, SR-09, SR-10, SR-17, SD-01, SD-02, SD-03, SD-04, SD-06, SD-07, BD-01 |
| BD-04 | SR-04, SR-05, SR-09, SR-13, SR-14, SR-17, SD-04, SD-05, SD-06, BD-03 |
| BD-05 | SR-04, SR-09, SR-10, SR-14, SD-02, SD-03, SD-06 |
...
### 3. フェーズ間の自動進行禁止（最重要）
- このフェーズが完了しても、次フェーズ（05_detailed-design）へ自動的に進んではならない
- フェーズ完了後は以下のメッセージを提示して待機する

```
✅ 04_basic-design が完了しました。
次フェーズ（05_detailed-design）を開始する場合は、その旨を指示してください。
```
...
`../artifacts/03_system-design/outputs/` 配下の全成果物が揃っていることを確認する。
...
- ツール・エージェント・ハンドラーは対象コンポーネントごとに個別ファイルを作成する
...
品質チェック結果は `../artifacts/04_basic-design/reviews/フェーズ品質チェック_review.md` に保存する。

合格後、workflow-state.md を以下のように更新する。
- 「品質チェック」列を `✅ 合格` に変更
- 「現在のフェーズ」を `05_detailed-design` に更新
